...
name: ship
description: >
  Use when the user is about to merge, ship, release, or deploy, or asks "is this
  safe to merge", "can I ship this", "ready to release", or wants a go/no-go on a
  branch or PR. Runs a pre-merge/pre-deploy checklist before it goes to
