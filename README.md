...
| [fix-with-spec](./skills/engineering/fix-with-spec/SKILL.md) | Repo-agnostic version of `fix`: keeps OpenSpec specs consistent under any schema by discovering schemas/apply steps from the OpenSpec CLI; hard-depends on `diagnosing-bugs`, `tdd-loop`, `/opsx:propose`. |
